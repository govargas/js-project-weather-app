...
var getLocalHours = function (unixTime) { return new Date(unixTime * 1000).getHours(); };
// Style Page by Time of Day (ToD)
var updatePageStyle = function () {
    var currentHour = getLocalHours(weatherData.dt);
    var sunriseHour = getLocalHours(weatherData.sys.sunrise);
    var sunsetHour = getLocalHours(weatherData.sys.sunset);
    var isDaytime = currentHour >= sunriseHour && currentHour < sunsetHour;
    document.body.classList.add(isDaytime ? "daytime" : "nighttime");
    console.log("Current Hour: ".concat(currentHour, ", Sunrise Hour: ").concat(sunriseHour, ", Sunset Hour: ").concat(sunsetHour));
};
// Fetch API
var fetchWeatherData = function () { return __awaiter(_this, void 0, void 0, function () {
...
var loadWeatherData = function () {
    container.innerHTML += "\n  <div class=\"landing-page-container\">\n    <div class=\"image-container\">\n      <img src=\"\" alt=\"\">\n    </div>\n    <h1>".concat(weatherData.main.temp, "\u00B0 C</h1>\n    <h2>").concat(weatherData.name, "</h2>\n    <h3>").concat(weatherData.weather[0].description, "</h3>\n    <div class=\"sunrise-sunset\">\n      <div class=\"sunrise-container\">\n        <p><b>Sunrise</b></p>\n        <p>").concat(new Date(weatherData.sys.sunrise * 1000).toLocaleTimeString(), "</p>\n      </div>\n      <div class=\"sunset-container\">\n        <p>Sunset</p>\n        <p>").concat(new Date(weatherData.sys.sunset * 1000).toLocaleTimeString(), "/p>\n      </div>\n    </div>\n    <button>&#x3e;</button>\n  </div>");
};
fetchWeatherData();
